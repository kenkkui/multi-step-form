    ...
    if (info.step3.cardInfos.hasOwnProperty(cardName)) {
      setInfo((prev) => {
        const updatedValues = {
          ...
          step3: {
            ...
            selectedCards: info.step3.selectedCards.filter(
              (item) => item !== id
            ),
          },
        };
      ...
      setInfo((prev) => {
        ...
        const updatedValues = {
          ...prev,
          step3: {
            selectedCards: [...prev.step3.selectedCards, id],
            cardInfos: {
              ...prev.step3.cardInfos,
              [cardName]: price,
            },
  ...
  return (
    <main id="step-three">
      <section className="card-wrapper">
        {CARDS.map((card) => {
          const periodCheck =
            info.step2.period === "monthly"
              ? card.monthlyPrice
              : card.yearlyPrice;
          const amountPeriod = info.step2.period === "monthly" ? "/mo" : "/yr";
